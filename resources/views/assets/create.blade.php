                ...
                <form action="{{ route('assets.store') }}" method="POST" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="name" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="text" name="name" value="{{ old('name') }}" required autofocus />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="category" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="text" name="category" value="{{ old('category') }}" required placeholder="cth: Elektronik, Furnitur" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="location" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="text" name="location" value="{{ old('location') }}" required placeholder="cth: Lantai 5, Gudang" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="quantity" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="number" name="quantity" value="{{ old('quantity', 1) }}" required min="1" />
                        </div>
                    </div>
