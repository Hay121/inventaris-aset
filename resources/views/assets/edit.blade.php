        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
            ...
            <div class="p-6 md:p-8 bg-gradient-to-b from-gray-800 to-gray-900 text-white rounded-t-lg md:rounded-l-lg md:rounded-t-none">
                ...
                <p class="mt-4 text-gray-300">
                    Anda sedang mengedit aset: <strong class="text-indigo-300">{{ $asset->name }}</strong>.
                </p>
                <p class="mt-2 text-gray-300">
                    Gunakan panduan ini untuk memastikan konsistensi data.
                </p>
                ...
                <form action="{{ route('assets.update', $asset->id) }}" method="POST" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="name" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="text" name="name" value="{{ old('name', $asset->name) }}" required autofocus />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="category" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="text" name="category" value="{{ old('category', $asset->category) }}" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="block mt-2 w-full rounded-md shadow-sm border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                            ...
                            <option value="Perbaikan" {{ old('status', $asset->status) == 'Perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="location" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="text" name="location" value="{{ old('location', $asset->location) }}" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input id="quantity" class="block w-full pl-10 rounded-md border-gray-300 bg-gray-50 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500" type="number" name="quantity" value="{{ old('quantity', $asset->quantity) }}" required min="1" />
                        </div>
                    </div>

                    <div class="flex items-center justify-end pt-8 border-t border-gray-200">
                        <a href="{{ route('assets.index') }}" class="text-sm font-semibold text-gray-600 hover:text-gray-900 mr-4 transition">
                            Batal
                        </a>
                        <button type="submit" 
