            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('assets.index') }}" 
                   class="flex items-center gap-3 px-6 py-3 text-sm font-semibold transition-colors duration-200
                          {{ (request()->routeIs('assets.index') || request()->routeIs('assets.index.root') || request()->routeIs('assets.edit')) 
                ...
                <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex items-center">
                            <form action="{{ route('assets.index') }}" method="GET" class="flex w-full md:w-96">
